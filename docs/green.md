...
Specific details on operation and dataset:
...
* Source data: 64 tiles (OME-Zarr format) of 6400 x 6400 x 16 bit = ~5GB
* Resulting fused data: 50438 x 50502 x 16 bit = ~5GB
